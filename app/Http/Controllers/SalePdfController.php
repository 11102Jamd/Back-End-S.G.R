...
/**
 * controlador para la generacion de PDF de Ventas
 *
 * Este controlador encapsula la logica de exportacion de un PDF
 * que contiene todo el historial de las ventas Realizadas
 *
...
class SalePdfController extends Controller
{
     ...
     * dentro del controlador SalePdfController, para poder generar y personalizar
