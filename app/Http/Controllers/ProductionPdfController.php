 ...
 * que contiene todo el historial de las producciones Realizadas
 *
...
class ProductionPdfController extends Controller
{
     ...
     * dentro del controlador ProductionPdfController, para poder generar y personalizar
    ...
    public function exportPdf(Request $request)
    {
        try {
            ...
            /**
             * Consulta establlecida con las relaciones
             */
            $productions = Production::with(['productionConsumptions.batch.input', 'productProductions.product', 'recipe'])
            ...
            //Suma el total de todas las producciones generadas
